...
# 환경변수에서 봇 토큰 불러오기
# ------------------------------
load_dotenv()  # 로컬 .env 파일용 (Railway에서는 대시보드 환경변수 사용)
bot_token = os.getenv("BOT_TOKEN")
if not bot_token:
    print(Fore.RED + "Error: BOT_TOKEN 환경변수가 설정되지 않았습니다." + Style.RESET_ALL)
    sys.exit(1)
...
async def check_and_update_files():
    ...
    try:
        ...
        print(Fore.YELLOW + "Cannot connect to GitHub, trying alternative source..." + Style.RESET_ALL)
        return False
